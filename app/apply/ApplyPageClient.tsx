...
function ApplyPageContent() {
  ...
  /* ------------------------------------------------------------------
   *  DEBUG: Output current language & a sample translation to console
   * ------------------------------------------------------------------*/
  console.log('Apply Page - Current language:', language);
  console.log('Apply Page - Test translation:', t('locationsPage.applyPage.hero.title'));
  console.log('Apply Page - Translation function type:', typeof t);
  ...
  /* ──────────────────────────────────────────────────────────
   *  SSR renders Hero;  client renders interactive sections
   * ────────────────────────────────────────────────────────── */
...
export default function ApplyPageClient({ language }: { language?: Language }) {
  /* 
